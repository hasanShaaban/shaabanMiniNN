...
y = np.array([
    [80*0.5 + 2*20 + 1*15 - 20*1.5 + 0*25 + 10],
    [100*0.5 + 3*20 + 1*15 - 15*1.5 + 1*25 + 10],
    [120*0.5 + 3*20 + 2*15 - 10*1.5 + 1*25 + 10],
    [60*0.5 + 2*20 + 1*15 - 30*1.5 + 0*25 + 10],
    [200*0.5 + 4*20 + 2*15 - 5*1.5  + 1*25 + 10],
    [150*0.5 + 4*20 + 2*15 - 8*1.5  + 0*25 + 10],
    [90*0.5  + 2*20 + 1*15 - 12*1.5 + 0*25 + 10],
    [110*0.5 + 3*20 + 1*15 - 20*1.5 + 1*25 + 10],
    [130*0.5 + 3*20 + 2*15 - 6*1.5  + 1*25 + 10],
    [70*0.5  + 2*20 + 1*15 - 25*1.5 + 0*25 + 10],
    [160*0.5 + 4*20 + 2*15 - 10*1.5 + 1*25 + 10],
    [140*0.5 + 3*20 + 2*15 - 15*1.5 + 0*25 + 10],
    [85*0.5  + 2*20 + 1*15 - 18*1.5 + 0*25 + 10], 
    [175*0.5 + 4*20 + 2*15 - 7*1.5  + 1*25 + 10],
    [95*0.5  + 3*20 + 1*15 - 10*1.5 + 0*25 + 10], 
], dtype=float)
